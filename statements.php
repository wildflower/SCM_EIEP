...
$replace_stmt = $dbh->prepare("REPLACE INTO $project_table (
...
$manual_statement = "insert into $project_table (icp, icpcreationdate, auditnumber, connection) VALUES( :icp, :icpcreationdate, :auditnumber,:connection ) on duplicate key update 
